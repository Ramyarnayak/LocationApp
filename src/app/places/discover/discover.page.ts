...
import { Place, searchPlace } from '../place.model';
...
export class DiscoverPage implements OnInit, OnDestroy {
  ...
  private searchplacesSub: Subscription;
  results: searchPlace[]
  isloading = false;
  public categories = [];
  isLoadImage: boolean;
  ...
  ngOnInit() {
    ...
    this.searchplacesSub = this.placesService.searchplaces.subscribe(places => {
      this.results = places;
      console.log(places)
    });
  ...
  onClickDiscoverTitle(title)
{
  if(title==="For the Weekend"){
 ...
 if(category.name == "Bank"){
  ...
  ngOnDestroy() {
    ...
    if (this.searchplacesSub) {
      this.searchplacesSub.unsubscribe();
    }
  }
